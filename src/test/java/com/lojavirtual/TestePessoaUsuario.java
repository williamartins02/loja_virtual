 ...
 * 
 * import com.lojavirtual.controller.PessoaController; import
 * com.lojavirtual.model.PessoaJuridica; import
 * com.lojavirtual.service.exception.ExceptionJava;
 * 
 * import junit.framework.TestCase;
 * 
 * @Profile("test")
 * 
 * @SpringBootTest(classes = LojaVirtualApplication.class) public class
 * TestePessoaUsuario extends TestCase {
 * 
 * @Autowired private PessoaController pessoaController;
 * 
 * @Test public void testCadPessoaFisica() throws ExceptionJava {
 * 
 * PessoaJuridica pessoaJuridica = new PessoaJuridica();
 * pessoaJuridica.setCnpj("54563644000117" +
